...
pub(super) fn generate_readme(
    ...
    let readme_content = r#"# Migrated Pelican Site

This Jekyll site was automatically migrated from a Pelican site using Rustyll.

## Structure

- `_posts/` - Contains blog posts migrated from the Pelican site
- `_pages/` - Contains static pages migrated from the Pelican site
...
The following Pelican components were migrated:

- Content files (markdown and restructured text)
...
Originally generated from a Pelican site using Rustyll, a migration tool for static site generators.
"#;
